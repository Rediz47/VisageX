...
export const RATIO_GROUP_MAP: Record<string, string> = {
  fWHR: 'Face Structure',
  'Jaw Angle': 'Face Structure',
  'Jaw/Cheek': 'Face Structure',
  Thirds: 'Face Structure',
  'Lower Face': 'Face Structure',
  Midface: 'Face Structure',
  Forehead: 'Face Structure',
  'Jaw/Height': 'Face Structure',
  'Chin Height': 'Face Structure',
  'Face Index': 'Face Structure',
  'Canthal Tilt': 'Eyes',
  'Eye Shape': 'Eyes',
  'Eye Spacing': 'Eyes',
  'Eye/Face W': 'Eyes',
  ...
  'Mouth/Face': 'Nose & Mouth',
  Philtrum: 'Nose & Mouth',
  'Lip Ratio': 'Nose & Mouth',
  'Nasal Index': 'Nose & Mouth',
  'Nose/Eye W': 'Nose & Mouth',
  'Bridge/Alar': 'Nose & Mouth',
  'φ Ratio': 'Harmony',
  Symmetry: 'Harmony'
};
