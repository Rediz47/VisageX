  ...
  return useMemo(() => {
    ...
    if (!isNaN(fwhr)) {
      ...
      result.push({
        ...
        unit: 'x',
        description:
          'Bizygomatic width divided by upper-face height. Values near 1.9–2.0 are linked to perceived dominance and attractiveness across cultures.',
    ...
    if (!isNaN(gr)) {
      ...
      result.push({
        ...
        unit: 'φ',
        description:
          'The Golden Ratio (1.618) measures how closely your facial proportions align with the mathematically ideal ratio found throughout nature and classical art.',
    ...
    if (!isNaN(sym)) {
      ...
      result.push({
        ...
        unit: '%',
        description:
          'Measures how closely left and right halves mirror each other across 468 landmark pairs. Higher values signal superior developmental stability.',
        contributesTo: ['Harmony', 'Symmetry'],
    ...
    if (!isNaN(ct)) {
      ...
      result.push({
        ...
        unit: '°',
        description:
          'Angle from inner to outer eye corner. Positive tilt of 4–8° signals youth and alertness. Negative tilt creates a tired or sad appearance.',
    ...
    if (breakdown.Jawline !== undefined) {
      ...
      result.push({
        ...
        unit: '°',
        description:
          'Sharpness of the jaw angle. Lower values (120–130°) create a chiseled jawline; higher values appear softer and rounder.',
    ...
    if (breakdown.Eyes !== undefined) {
      ...
      result.push({
        ...
        unit: 'x',
        description:
          'Eye width to height ratio. Almond-shaped eyes with 2.8–3.0x are considered most aesthetically pleasing across cultures.',
    ...
    if (points && points.length >= 468) {
      ...
      if (thirds > 0) {
        ...
        result.push({
          ...
          contributesTo: ['Harmony', 'Proportions'],
          lines: [
      ...
      if (avgEyeW > 0 && innerEyeSpacing > 0) {
        ...
        result.push({
          ...
          shortName: 'Eye Spacing',
          value: ratio,
          idealRange: [0.85, 1.15],
          score,
          unit: 'x',
          description:
            'Inner-corner spacing (endocanthion–endocanthion) divided by average eye width. Ideal ≈ 1.0 (eyes spaced exactly one eye-width apart) — the classical neoclassical canon standard.',
          contributesTo: ['Features', 'Harmony'],
          lines: [
      ...
      if (faceW > 0 && avgEyeW > 0) {
        ...
        result.push({
          name: 'Eye-to-Face Width Ratio',
          shortName: 'Eye/Face W',
          value: ratio,
          idealRange: [0.6, 0.76],
          score,
          unit: 'x',
          description:
            'Combined eye span as a fraction of face width. Ideal ~0.68 means your eye region spans ~2/3 of face width — a key harmony marker.',
          contributesTo: ['Features', 'Harmony'],
          lines: [
            { from: 133, to: 362, color: lc(score, 0.9) },
      ...
      if (jawW > 0 && faceW > 0) {
        ...
        result.push({
          name: 'Jaw-to-Cheekbone Width',
          shortName: 'Jaw/Cheek',
          value: ratio,
          idealRange: [0.72, 0.88],
          score,
          unit: 'x',
          description:
            'Jaw width relative to cheekbone width. A ratio of ~0.8 creates the classic inverted triangle — wide cheekbones tapering to a narrower jaw.',
          contributesTo: ['Angularity', 'Dimorphism'],
          lines: [
      ...
      if (noseW > 0 && mouthW > 0) {
        ...
        result.push({
          name: 'Nose-to-Mouth Width',
          shortName: 'Nose/Mouth',
          value: ratio,
          idealRange: [0.72, 0.88],
          score,
          unit: 'x',
          description:
            'Nose width as a fraction of mouth width. Ideal ≈ 0.8 (nose slightly narrower than mouth). Central to golden-ratio facial analysis systems.',
          contributesTo: ['Features', 'Harmony'],
          lines: [
      ...
      if (mouthW > 0 && faceW > 0) {
        ...
        result.push({
          name: 'Mouth-to-Face Width',
          shortName: 'Mouth/Face',
          value: ratio,
          idealRange: [0.4, 0.52],
          score,
          unit: 'x',
          description:
            'Mouth width as a fraction of total face width. Ideal ~0.46 places mouth corners directly below the pupils — a key harmony marker.',
          contributesTo: ['Harmony', 'Proportions'],
          lines: [
      ...
      if (philLen > 0 && noseLen > 0) {
        ...
        result.push({
          name: 'Philtrum-to-Nose Length',
          shortName: 'Philtrum',
          value: ratio,
          idealRange: [0.65, 0.85],
          score,
          unit: 'x',
          description:
            'Philtrum length relative to nose length. A shorter philtrum (0.7–0.8) is associated with youth and attractiveness — longer philtrum signals age.',
          contributesTo: ['Features', 'Youth'],
          lines: [
      ...
      if (upperLipH > 0 && lowerLipH > 0) {
        ...
        result.push({
          ...
          unit: 'x',
          description:
            'Upper-to-lower lip thickness. Ideal ≈ 0.72 means the lower lip is slightly fuller — a classic sign of youth and attractiveness.',
          contributesTo: ['Features', 'Youth'],
          lines: [{ from: 13, to: 14, color: lc(score, 0.9) }],
          dots: [13, 14]
        });
      }
      ...
      if (faceH > 0 && lower > 0) {
        ...
        result.push({
          name: 'Lower Face Ratio',
          shortName: 'Lower Face',
          value: ratio,
          idealRange: [0.28, 0.38],
          score,
          unit: 'x',
          description:
            'Lower third (nose to chin) as a fraction of total face height. Balanced at ~0.33. Shorter lower face signals youth; longer lower face signals maturity.',
          contributesTo: ['Proportions', 'Harmony'],
          lines: [
      ...
      if (faceH > 0 && mid > 0) {
        ...
        result.push({
          ...
          unit: 'x',
          description:
            'Middle third (brow to nose base) as a fraction of total face height. Balanced at ~0.33. Longer midface indicates more elongated facial proportions.',
          contributesTo: ['Proportions', 'Harmony'],
          lines: [
            { from: 9, to: 2, color: lc(score, 0.9) },
      ...
      if (intercanthal > 0 && faceW > 0) {
        ...
        result.push({
          name: 'Intercanthal Distance Ratio',
          shortName: 'Intercanthal',
          value: ratio,
          idealRange: [0.28, 0.36],
          score,
          unit: 'x',
          description:
            'Distance between the inner eye corners (endocanthion) relative to face width. Ideal ~0.32 aligns inner corners above the alar base, a key marker of orbital harmony and classic beauty canons.',
          contributesTo: ['Features', 'Harmony'],
          lines: [
      ...
      if (noseW > 0 && noseLen > 0) {
        ...
        result.push({
          ...
          value: ratio,
          idealRange: [0.55, 0.77],
          score,
          unit: 'x',
          description:
            'Nose width divided by nose length. A nasal index of 0.60–0.70 is associated with facial harmony in neoclassical canon analysis. Higher values indicate broader nasal ala relative to projection.',
          contributesTo: ['Features', 'Proportions'],
          lines: [
      ...
      if (chinH > 0 && lower > 0) {
        ...
        const score = Math.min(10, Math.max(0, 10 - Math.abs(ratio - 0.5) * 20));
        result.push({
          name: 'Chin Height Ratio',
          shortName: 'Chin Height',
          value: ratio,
          idealRange: [0.42, 0.58],
          score,
          unit: 'x',
          description:
            'Chin height (lip-to-chin) as a proportion of the lower facial third. Ideal ≈ 0.50 creates balanced chin projection. Lower ratios signal a recessed chin; higher values suggest vertical excess.',
          contributesTo: ['Angularity', 'Proportions'],
          lines: [
      ...
      if (faceH > 0 && upper > 0) {
        ...
        result.push({
          ...
          unit: 'x',
          description:
            'Upper third (hairline to brow) as a fraction of total face height. Balanced at ~0.33. A high forehead ratio can affect perceived facial elongation and aesthetic balance of upper-face features.',
          contributesTo: ['Proportions', 'Harmony'],
          lines: [
      ...
      if (jawW > 0 && faceH > 0) {
        ...
        const score = Math.min(10, Math.max(0, 10 - Math.abs(ratio - 0.75) * 16));
        result.push({
          name: 'Bigonial to Face Height',
          shortName: 'Jaw/Height',
          value: ratio,
          idealRange: [0.65, 0.85],
          score,
          unit: 'x',
          description:
            'Jaw width (bigonial distance) relative to total face height. Ideal ~0.75 creates a strong, proportional lower face structure. Low values suggest a narrow jaw; high values indicate excessive jaw width.',
          contributesTo: ['Angularity', 'Dimorphism'],
          lines: [
      ...
      if (avgEyeW > 0 && noseW > 0) {
        ...
        result.push({
          name: 'Nasal-to-Orbital Width',
          shortName: 'Nose/Eye W',
          value: ratio,
          idealRange: [0.85, 1.15],
          score,
          unit: 'x',
          description:
            'Nasal alar width compared to average eye width. The neoclassical canon states ideal nose width equals one eye width. Deviations signal nasal width imbalance relative to orbital frame.',
          contributesTo: ['Features', 'Proportions'],
          lines: [
            { from: 49, to: 279, color: lc(score, 0.95) },
            { from: 33, to: 133, color: lc(score, 0.5) },
      ...
      if (faceW > 0 && faceH > 0) {
        ...
        const score = Math.min(10, Math.max(0, 10 - Math.abs(ratio - 0.8) * 16));
        result.push({
          name: 'Facial Index',
          ...
          unit: 'x',
          description:
            'Bizygomatic width divided by total face height. Mesoprosopic faces (0.78–0.85) are considered most harmonious. Euryprosopic (wide) or leptoprosopic (narrow) faces deviate from classical proportions.',
          contributesTo: ['Harmony', 'Proportions'],
          lines: [
      ...
      if (avgEyeH > 0 && avgEyeW > 0) {
        ...
        const score = Math.min(10, Math.max(0, 10 - Math.abs(ratio - 0.3) * 30));
        result.push({
          name: 'Palpebral Height Ratio',
          shortName: 'Eye Open',
          value: ratio,
          idealRange: [0.25, 0.36],
          score,
          unit: 'x',
          description:
            'Vertical eye opening (upper to lower eyelid) divided by eye width. Ideal ~0.30 creates almond-shaped eyes. Lower values indicate hooded or narrower eyes; higher values suggest round, open eyes.',
          contributesTo: ['Features', 'Angularity'],
          lines: [
            { from: 159, to: 145, color: lc(score, 0.95) },
            { from: 386, to: 374, color: lc(score, 0.95) },
            { from: 33, to: 133, color: lc(score, 0.4) },
            { from: 263, to: 362, color: lc(score, 0.4) }
          ],
      ...
      if (browEyeR > 0 && browEyeL > 0 && faceH > 0) {
        ...
        result.push({
          ...
          unit: 'x',
          description:
            'Distance from brow arch peak to upper eyelid, normalized to face height. Ideal ~7–8% of face height. Low values indicate heavy brows or ptosis; excessive elevation suggests a surprised expression or over-arched brows.',
          contributesTo: ['Features', 'Harmony'],
          lines: [
      ...
      if (noseBridgeW > 0 && noseW > 0) {
        ...
        const score = Math.min(10, Math.max(0, 10 - Math.abs(ratio - 0.6) * 18));
        result.push({
          name: 'Nose Bridge Width Ratio',
          ...
          unit: 'x',
          description:
            'Nasal bridge width relative to alar (nostril) width. Ideal ~0.60 indicates a gently tapering nose with a narrower bridge than base. Higher values suggest a wide dorsum; lower values a very pinched bridge.',
          contributesTo: ['Features', 'Proportions'],
          lines: [
