    ...
    >
      ...
      <div className="space-y-12">
        <section>
          ...
          >
            By accessing or using VisageX, you agree to be bound by these Terms of Service and all
        ...
        <section>
          ...
          >
            Permission is granted to use VisageX for personal, non-commercial facial analysis. This
        ...
        <section>
          ...
          >
            By using VisageX, you consent to the processing of your biometric data for the purpose
