    ...
    <div className="space-y-6 md:space-y-8">
        ...
        >
          ...
          <div className="relative">
            <div className="flex items-center gap-3 mb-6">
              <div
                className={cn('p-2.5 rounded-xl', isDarkMode ? 'bg-cyan-500/20' : 'bg-cyan-100')}
              >
      ...
      >
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-6">
            <div
              className={cn('p-2.5 rounded-xl', isDarkMode ? 'bg-purple-500/20' : 'bg-purple-100')}
            >
            ...
            <div>
              ...
              <p
                className={cn('text-xs', isDarkMode ? 'text-purple-300/50' : 'text-purple-600/50')}
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            <div
              className={cn(
                'p-4 md:p-5 rounded-xl border transition-all duration-300 hover:-translate-y-0.5',
                isDarkMode
            ...
            >
              <div className="flex items-center gap-1 mb-2">
                ...
                <Tooltip
                  content="The angle of the eye's outer corner relative to the inner corner."
            ...
            >
              <div className="flex items-center gap-1 mb-2">
                ...
                <Tooltip
                  content="The ratio of facial width to facial height."
                  isDarkMode={isDarkMode}
                />
              </div>
              <p
            ...
            >
              <div className="flex items-center gap-1 mb-2">
                ...
                <Tooltip
                  content="A mathematical ratio (1.618) used as a standard for facial harmony."
                  isDarkMode={isDarkMode}
                />
              </div>
              <p
