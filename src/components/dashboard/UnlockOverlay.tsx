    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex-1 text-center lg:text-left">
          <h3
            className={cn(
              'text-4xl md:text-5xl lg:text-6xl font-display italic mb-3 leading-tight',
          ...
          <p
            className={cn(
              'text-base md:text-xl opacity-60 font-light mb-8 max-w-lg',
              isDarkMode ? 'text-white' : 'text-zinc-600'
            )}
          >
            See your full breakdown & how to reach 9.0+
          </p>
        ...
        >
          ...
          <div className="text-center relative z-10">
            <p className="text-[10px] uppercase tracking-widest opacity-40 mb-1 font-bold">
              Total Access
            </p>
            <p
              className={cn(
                'text-5xl font-display italic font-bold',
                isDarkMode ? 'text-zinc-100' : 'text-zinc-900'
              )}
            >
