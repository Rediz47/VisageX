  ...
  return (
    <div className="lg:col-span-12 mt-8 md:mt-12">
      <div className="mb-6 md:mb-8">
        <h3
          className={cn(
            'text-2xl md:text-3xl font-display italic mb-2',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-6">
        <div
          className={cn(
            ...
            isDarkMode
              ? 'bg-gradient-to-br from-emerald-950/20 to-emerald-900/10 border-emerald-500/30'
            ...
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              ...
              <div>
                ...
                <p
                  className={cn(
                    'text-xs',
                    isDarkMode ? 'text-emerald-300/50' : 'text-emerald-600/50'
                  )}
                >
            ...
            <ul className="space-y-1.5 md:space-y-2">
              {isLocked ? (
                <li
                  className={cn(
                    ...
                    isDarkMode
                      ...
                      : 'bg-white border-emerald-100 text-emerald-700/40'
                  )}
                >
                ...
                strengths.map((strength: string, i: number) => {
                  const guideMatch = KEYWORD_GUIDE_MAP.find((m) =>
                    strength.toLowerCase().includes(m.keyword.toLowerCase())
                  );
                  return (
                    <li
                      key={i}
                    ...
                    >
                      ...
                      <span
                        className={cn(
                          'flex-grow text-sm md:text-base',
        ...
        <div
          className={cn(
            'rounded-2xl md:rounded-3xl p-6 md:p-8 border shadow-lg relative overflow-hidden',
            isDarkMode
              ? 'bg-gradient-to-br from-rose-950/20 to-rose-900/10 border-rose-500/30'
        ...
        >
          ...
          <div className="relative">
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              <div
                className={cn('p-2.5 rounded-xl', isDarkMode ? 'bg-rose-500/20' : 'bg-rose-100')}
              >
              ...
              {isLocked ? (
                <li
                  className={cn(
                    'flex items-center gap-3 p-3 rounded-xl border',
                    isDarkMode
                      ? 'bg-white/5 border-white/10 text-rose-200/40'
                      : 'bg-white border-rose-100 text-rose-700/40'
                  )}
                >
                ...
                weaknesses.map((weakness: string, i: number) => {
                  const guideMatch = KEYWORD_GUIDE_MAP.find((m) =>
                    weakness.toLowerCase().includes(m.keyword.toLowerCase())
                  );
                  return (
                    <li
                      key={i}
