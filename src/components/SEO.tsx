...
const SEO: React.FC<SEOProps> = ({
  ...
  description = 'Get your AI face score in seconds. VisageX scans 468 facial landmarks to rate symmetry, jawline, surface clarity & more. Free online tool — no download needed.',
