              ...
              {user ? (
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className={`flex items-center gap-2 rounded-2xl px-4 py-2.5 transition-all duration-300 ${isDarkMode ? 'border border-amber-500/20 bg-amber-500/10 text-amber-300 shadow-lg shadow-amber-950/10 hover:bg-amber-500/20' : 'border border-amber-200 bg-amber-50 text-amber-700 shadow-sm hover:bg-amber-100'}`}
                  >
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`group flex items-center gap-3 rounded-2xl border py-2 pl-2 pr-3 transition-all duration-300 ${isDarkMode ? 'border-white/10 bg-white/[0.06] shadow-2xl shadow-indigo-950/10 hover:bg-white/[0.1]' : 'border-zinc-200 bg-white/70 shadow-lg shadow-zinc-200/40 hover:bg-white'}`}
                    >
                      <div className="relative">
                        {user.photoURL ? (
                          <img
                    ...
                    <AnimatePresence>
                      {accountOpen && (
                        <motion.div
                          ...
                          transition={{
                            duration: preset.durations.fast,
                ...
                <div className="flex items-center gap-5">
                  ...
                  <button
                    ...
                    className={`rounded-full px-6 py-2.5 text-[10px] font-bold uppercase tracking-[0.2em] transition-all ${isDarkMode ? 'bg-white text-black hover:bg-zinc-200' : 'bg-zinc-900 text-white hover:bg-black'}`}
                  >
                    Sign Up
                  </button>
                </div>
