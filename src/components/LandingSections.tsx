              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-12 ml-6 md:ml-12 lg:ml-24">
                ...
                <div className="flex flex-col gap-4">
                  <button 
                    ...
                    className={`px-10 py-5 rounded-full font-bold uppercase tracking-widest text-xs transition-all duration-500 shadow-xl ${
                      isDarkMode 
                  ...
                  <button 
                    ...
                    className={`px-10 py-5 rounded-full font-bold uppercase tracking-widest text-xs border transition-all duration-500 ${
                      isDarkMode 
