...
export function PasscodeGate({ children, isDarkMode }: { children: React.ReactNode, isDarkMode: boolean }) {
  ...
  return (
    <div className={cn(
      ...
      >
        ...
        <p className={cn("text-center mb-8 text-sm", isDarkMode ? "text-white/50" : "text-zinc-500")}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            />
            {error && (
              <p className="text-rose-500 text-xs text-center mt-2">Incorrect passcode</p>
            )}
          </div>
