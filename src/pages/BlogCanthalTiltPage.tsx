...
export default function BlogCanthalTiltPage() {
  ...
  const Card = ({
    ...
    >
      <div
        className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-8 ${isDarkMode ? 'bg-sky-500/20 text-sky-400' : 'bg-sky-50 text-sky-600'}`}
      >
      ...
      <article className="pt-32 pb-20 px-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <header className="text-center max-w-3xl mx-auto space-y-6">
            <div
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest border ${isDarkMode ? 'border-sky-500/30 text-sky-400 bg-sky-500/10' : 'border-sky-200 text-sky-600 bg-sky-50'}`}
            >
          ...
          >
            ...
            >
              Stop guessing your eye shape in the mirror. Use our{' '}
              <Link to="/" className="text-sky-500 font-bold hover:underline">
                AI face rater
              </Link>{' '}
              to generate an exact protractor measurement of your canthal tilt in seconds.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            >
              The 3 Types of Canthal Tilt
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card icon={Activity} title="Positive Tilt (+)">
                <p>
                  The outer corner (lateral canthus) is sitting higher than the inner corner (medial
                  canthus). This is universally considered the most attractive, high-trust, and
                  dimorphic trait in both men ("Hunter Eyes") and women (feline, siren eyes).
                </p>
              </Card>
              <Card icon={Rulers} title="Neutral Tilt (0)">
                <p>
                  The inner and outer corners are parallel to the horizon. This is incredibly common
                  and perfectly normal, often leading to a highly friendly "almond" or soft
                  rectangular eye shape. It denotes approachability.
                </p>
              </Card>
              <Card icon={Sparkles} title="Negative Tilt (-)">
                <p>
                  The outer corner drops lower than the inner corner. While often criticized in
                  looksmaxxing circles as "prey eyes" because it can give off a tired, sad, or
                  highly sympathetic look, it suits certain bone structures beautifully (like
                  Marilyn Monroe).
                </p>
              </Card>
            </div>
          ...
          >
            ...
            <div className="space-y-8">
              <div>
                <h3
                  className={`text-xl font-bold mb-3 ${isDarkMode ? 'text-sky-400' : 'text-sky-600'}`}
                >
                  The Hard Truth
                </h3>
                <p
                ...
                >
                  Your canthal tilt is determined by your orbital bone socket and the specific
                  attachment of your lateral canthal tendon. Therefore,{' '}
                  <strong>
                    pushing on your eyes, "bone-smashing", or Gua Sha will not change your tilt
                  </strong>
                  . The geometry is locked in structurally.
                </p>
              </div>
              <div>
                <h3
                ...
                <p
                  className={`text-base leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}`}
                >
                  Instead of trying to change the tilt, you should focus on the surrounding tissue.
                  Lowering body fat percentage reduces periocular puffiness. Using cold compresses
                  tightens the skin, revealing more of your natural eyelid fold. Non-surgical
                  options like Botox can slightly lift the tail of the brow, giving the *illusion*
                  of a more positive tilt.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-8">
              ...
              >
                Our 468-point neural mesh will calculate your exact left and right canthal tilt
                angles to the decimal point for free.
              </p>
