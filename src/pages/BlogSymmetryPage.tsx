...
export default function BlogSymmetryPage() {
  ...
  const Card = ({
    ...
    >
      <div
        className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-8 ${isDarkMode ? 'bg-emerald-500/20 text-emerald-400' : 'bg-emerald-50 text-emerald-600'}`}
      >
      ...
      <article className="pt-32 pb-20 px-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <header className="text-center max-w-3xl mx-auto space-y-6">
            ...
            >
              Uneven eyes? Tilted jawline? Discover the science behind facial asymmetry and what you
              can naturally do to fix it.
            </p>
          </header>
          ...
          >
            ...
            >
              If you want to find out exactly how symmetrical your face is right now, try our free{' '}
          ...
          <div className="space-y-8">
            ...
            >
              What Actually Causes Asymmetry?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card icon={Bed} title="Sleeping Habits">
                <p>
                  Consistently sleeping on one side of your face puts intense pressure on your
                  tissues, causing volume loss and skin laxity on that side over time. It can
                  actually reshape cartilage in your nose.
                </p>
              </Card>
              <Card icon={Dumbbell} title="Unbalanced Chewing">
                <p>
                  If you favor one side of your mouth while chewing food (or gum), the masseter
                  muscle on that side will grow larger (hypertrophy), leading to a highly uneven and
                  tilted lower jawline.
                </p>
              </Card>
              <Card icon={MoveDown} title="Poor Posture & Mewing">
                <p>
                  Neck posture and resting tongue position dictate how your facial bones develop.
                  Incorrect tongue posture reduces upward pressure on the maxilla (upper jaw),
                  leading to a flatter, less defined midface.
                </p>
              </Card>
              <Card icon={Compass} title="Genetics & Aging">
                <p>
                  Bone structure genetics play a massive baseline role. Additionally, as we age, we
                  experience asymmetric collagen and fat pad breakdown resulting in uneven folds.
                </p>
              </Card>
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-12">
              <div>
                <h3
                  className={`text-xl font-bold mb-3 ${isDarkMode ? 'text-emerald-400' : 'text-emerald-600'}`}
                >
                  1. Balance Your Chewing Ratio
                </h3>
                <p
                  className={`text-base leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}`}
                >
                  The masseter fix is the fastest way to balance the lower third of your face. Make
                  a conscious effort to chew your food evenly on both sides. If you use jawline
                  exercisers or mastic gum, strictly maintain a 50/50 ratio to prevent one side from
                  outgrowing the other.
                </p>
              </div>
              ...
              <div>
                ...
                <p
                  className={`text-base leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}`}
                >
                  Train yourself to sleep on your back. This not only prevents asymmetrical volume
                  loss on your cheeks but also stops the formation of "sleep wrinkles." Using a
                  specialized cervical pillow can help keep your head locked in place.
                </p>
              </div>
              ...
              <div>
                <h3
                  className={`text-xl font-bold mb-3 ${isDarkMode ? 'text-emerald-400' : 'text-emerald-600'}`}
                >
                  3. Practice Proper Oral Posture (Mewing)
                </h3>
                <p
                  className={`text-base leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}`}
                >
                  By resting your entire tongue flush against the roof of your mouth (lips sealed,
                  teeth gently touching), you provide upward pressure on the maxilla. Over years,
                  this forces the mid-face forward, creating sharper cheekbones and better overall
                  structural symmetry.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-8">
              ...
              >
                Upload a selfie and let our neural network scan 468 facial points to reveal any
                hidden asymmetries.
              </p>
